...
# Configuration
model_type = "LSTM"
training_data_path = Path("/Users/arnavde/Python/AI/kubeflow-02/ml_pipeline_v3/local_artifacts/test-fix/processed_data/training_data.parquet")
output_dir = Path("/Users/arnavde/Python/AI/kubeflow-02/ml_pipeline_v3/local_artifacts/test-fix") / "models" / "LSTM"
...
metrics_path = Path("/Users/arnavde/Python/AI/kubeflow-02/ml_pipeline_v3/local_artifacts/test-fix") / "metrics" / f"{model_type}_metrics.json"
