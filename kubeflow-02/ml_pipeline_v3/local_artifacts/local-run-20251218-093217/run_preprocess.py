...
output_dir = Path("/Users/arnavde/Python/AI/kubeflow-02/ml_pipeline_v3/local_artifacts/local-run-20251218-093217") / "processed_data"
...
config = {
    ...
    "identifier": "local-run-20251218-093217",
